...
public class RestModelWebAppInitializer implements WebApplicationInitializer{
	...
	public void onStartup(ServletContext container) throws ServletException {
	  ...
	  //  dispatcherContext.setParent(restContext);
	    restContext.register(QcWebControlerRepositoryRestMvcConfiguration.class);
	    DispatcherServlet dispatcherServlet = new RepositoryRestDispatcherServlet(restContext);
